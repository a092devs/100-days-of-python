...
radio_state = IntVar()
mile_to_km_radiobutton = Radiobutton(
    text="Mile to Km", value=1, variable=radio_state, command=radio_used
)
mile_to_km_radiobutton.grid(column=0, row=1)
cm_to_m_radiobutton = Radiobutton(
    text="CM to Meter", value=2, variable=radio_state, command=radio_used
)
cm_to_m_radiobutton.grid(column=1, row=1)
m_to_inch_radiobutton = Radiobutton(
    text="Meter to INCH", value=3, variable=radio_state, command=radio_used
)
m_to_inch_radiobutton.grid(column=0, row=2)
feet_to_inch_radiobutton = Radiobutton(
    text="Foot to INCH", value=4, variable=radio_state, command=radio_used
)

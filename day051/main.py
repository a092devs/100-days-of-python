...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        # pop up check
        pop_up = self.driver.find_element(
            By.XPATH,
    ...
    def tweet_at_provider(self):
        ...
        tweet = self.driver.find_element(
            By.XPATH,
            value='//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div/div/div[3]/div[2]/div[1]/div/div/div/div[1]/div[2]/div/div/div/div/div/div/div[2]/div/div/div/div/label/div[1]/div/div/div/div/div/div[2]/div/div/div/div',
        )
        tweet.send_keys(
            f"Hey Internet Provider, why is my internet speed {self.down} Mbps Download and {self.up} Mbps Upload when I pay for {PROMISED_DOWN} Mbps Download and {PROMISED_UP} Mbps Upload speed?\n\nAutomated tweet, please ignore!"
        )
        sleep(5)
        self.driver.find_element(
            By.XPATH,
